<!-- Menu --><?php include '../inc/datebase.php';?>
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <li class="menu-item">
        <a href="iletisim.php" class="menu-link"><i class="menu-icon fa-solid fa-headset"></i><div data-i18n="Cikis">İletişim</div></a>
    </li>
    <li class="menu-item">
        <a href="hakkimizda.php" class="menu-link"><i class="menu-icon fa-regular fa-address-card"></i><div data-i18n="Cikis">Hakkımızda</div></a>
    </li>
    </ul>
</aside>
<!-- / Menu -->