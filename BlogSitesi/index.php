          ...
          <div class="content-wrapper">
            ...
            <div class="container mt-3">
              ...
              if(isset($_GET['kategori'])) {
                $sql = $db->query("SELECT * FROM bloglar WHERE kategori = '$_GET[kategori]' ORDER BY id DESC");
                if(!$sql->rowCount()) {
                  ?>
                      <center><h1><i class="fa-solid fa-magnifying-glass mt-4"></i></h1></center>
                      <center><p>Blog bulunamadı...</p></center>
                  <?php  
                }
              }
              else
              {
                $sql = $db->query("SELECT * FROM bloglar ORDER BY id DESC");
              }
              while ($row = $sql->fetch()) {
                ?>
                    ...
                    <div class="card w-100 mb-3">
                      ...
                      <div class="card-body">
                        ...
                        <form action="" method="post">
                          <button class="btn btn-danger" name="sil" value="<?=$row['id']?>"><i class="fa-solid fa-trash"></i></button>
                        </form>
                      </div>
                    </div>
                  </a>
