      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <?php
            ...
            if($mesaj){
                $sql = $db->query("INSERT INTO bildirimler SET kisi='$kisi', bildirim='$mesaj'");
                if ($sql) {
                    $message = 1;
                }
            }
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-2">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text h-100">
                                                        <i class="fa fa-comment text-info my-auto"></i>
                                                    </div>
                                                </div>
                                                <textarea class="form-control" placeholder="Lütfen Mesajınızı Buraya Yazın.." rows="6" name="mesaj" required></textarea>
                                            </div>
                                        </div>
                                        <div class="text-center">
                                        <input type="submit" value="GÖNDER" class="btn btn-info btn-block w-100">
                                        </div>
                                    </div>
                                </div>
                            </form>
