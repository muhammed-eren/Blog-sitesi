        ...
        <div class="layout-page">
          ...
          <?php
            ...
            if(isset($_POST["btn"]))
            {
                ...
                {
                    if($mesaj == $kisi) {
                        $sql = $db->query("UPDATE kullanicilar SET sifre='$kisi' WHERE kullaniciadi = '{$_SESSION['username']}'");
                        if ($sql) {
                            $message = 1;
                        }
                    }
                                    ...
                                    <div class="card-body p-3">
                                        <div class="form-group">
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="text" class="form-control" name="sifre" placeholder="Yeni şifre" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="text" class="form-control" name="sifret" placeholder="Şifre tekrarı" required>
                                            </div>
                                        </div>
